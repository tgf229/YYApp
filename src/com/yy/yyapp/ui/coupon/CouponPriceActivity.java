 ...
 * @since  [产品/模块版本]
 */
public class CouponPriceActivity extends BaseActivity implements OnClickListener
{
    ...
    public void netBack(String service, String res)
    {
        ...
        if (URLUtil.PRICE_RANGE.equals(service))
        {
            if (dialog != null)
            {
            ...
            try
            {
                ...
                for (int i = 0; i < array.length(); i++)
                {
                    ...
                    String str = ob.getString("price_range");
                    typeList.add(str);
                }
                showList();
            }
