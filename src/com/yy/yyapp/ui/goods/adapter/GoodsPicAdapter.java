 ...
 * @since  [产品/模块版本]
 */
public class GoodsPicAdapter extends PagerAdapter implements IconPagerAdapter
{
    ...
    public GoodsPicAdapter(Context context, ArrayList<String> paths)
    {
        mContext = context;
        mPaths = paths;
    ...
    {
        View pageView = LayoutInflater.from(mContext).inflate(R.layout.goods_pic_loop_viewpager_item, null);
