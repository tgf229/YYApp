    ...
    OnItemSelectedListener, OnPoiSearchListener, OnMapClickListener, OnInfoWindowClickListener, OnClickListener
{
    ...
    public void nextSearch()
    {
        if (query != null && poiSearch != null && poiResult != null)
        {
            ...
            {
                ToastUtil.makeText(this,"对不起，没有搜索到相关数据");
            }
        }
    }
    ...
    private void showSuggestCity(List<SuggestionCity> cities)
    {
        ...
        {
            infomation +=
                "城市名称:" + cities.get(i).getCityName() + "城市区号:" + cities.get(i).getCityCode() + "城市编码:"
                    + cities.get(i).getAdCode() + "\n";
        }
        ToastUtil.makeText(this, infomation);
        ...
        if (rCode == 0)
        {
            ...
            {// 搜索poi的结果
                if (detailMarker != null)
                {
                    ...
                    {
                        ToastUtil.makeText(PoiAroundSearchActivity.this, "此Poi点没有深度信息");
                    }
                }
            ...
            {
                ToastUtil.makeText(PoiAroundSearchActivity.this,"对不起，没有搜索到相关数据");
            }
        }
        else if (rCode == 27)
        {
