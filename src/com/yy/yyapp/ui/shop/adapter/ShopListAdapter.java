...
public class ShopListAdapter extends BaseAdapter
{
    ...
    public ShopListAdapter(Context context, List<ShopBean> shopList, UICallBack callBack)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            mHolder.call = (LinearLayout)convertView.findViewById(R.id.call_layout);
        ...
        else
        {
            ...
            mHolder.call.setOnClickListener(new OnClickListener()
            {
                
                @Override
                public void onClick(View v)
                {
                    Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" + entity.getOrg_tel()));
